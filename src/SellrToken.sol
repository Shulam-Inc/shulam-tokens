...
/// @notice ERC-20 with emission-controlled minting. 1B max supply.
...
contract SellrToken is ERC20, ERC20Burnable, ERC20Permit, Ownable2Step {
    ...
    constructor(address initialOwner)
        ERC20("Shulam Seller Token", "SELLR")
        ERC20Permit("Shulam Seller Token")
